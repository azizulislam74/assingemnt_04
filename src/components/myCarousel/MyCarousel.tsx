...
const MyCarousel = () => {
    ...
    const carouselImages = ['https://i.ibb.co/D4WT5CS/pexels-coco-championship-191448-598631.jpg','https://i.ibb.co/56Xxt7M/pexels-football-wife-577822-1618269.jpg','https://i.ibb.co/ChLV2WW/pexels-noellegracephotos-906073.jpg','https://i.ibb.co/FwtzJTw/pexels-pixabay-46798.jpg','https://i.ibb.co/Nj7Xw3X/pexels-pixabay-248547.jpg'];
  ...
  return (
      <div className="max-h-screen w-full md:h-[470px] lg:h-[540px] relative overflow-hidden">
          {/* arrow left */}
          ...
          <div className="ease-linear duration-500 flex transform-gpu" style={{ transform: `translateX(-${currentSlider * 100}%)`}}>
            ...
            {carouselImages.map((slide, idx) => (
              <img key={slide} src={slide} className="min-w-full h-screen bg-black/20 sm:h-96 md:h-[540px] object-cover" alt={`Slider - ${idx + 1}`}/>
            ))}
          </div>
      </div>
  )
